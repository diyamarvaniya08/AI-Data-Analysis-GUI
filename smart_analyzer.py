# Data Analysis Project using A.I by Satish Dhawale
# (AI Prompt Engineering for GUI-Based Data Analysis Software)
...
- Display the chart inside the GUI window While displaying the chart it should display the entire chart,
 should not be crop the content
